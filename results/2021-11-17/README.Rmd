...
abline(h = 4.0e+06, col = 'red', lty = 2)
abline(h = 5.0e+06, col = 'orange', lty = 2)
abline(h = 6.0e+06, col = 'yellow', lty = 2)
...
abline(v = 4.0e+06, col = 'red', lty = 2)
abline(v = 5.0e+06, col = 'orange', lty = 2)
abline(v = 6.0e+06, col = 'yellow', lty = 2)
...
write.table(mapped[mapped$numReads < 4.0e+06, 'sample'],
            file = 'below4M.txt', row.names = FALSE,
            col.names = FALSE, quote = FALSE)
```

The image above shows what samples have fewer than 4 (red), 5 (orange)
or 6 (yellow) million reads. Removing the 6 samples with less than 4
million reads from the beginning may be safe.
