...
for i in $(seq 1 1000); do
   ...
   head -n 1 Fake_frequencies.tsv | tee A_$1.tsv > B_$1.tsv
   grep -F -f A_pos_$1.txt Fake_frequencies.tsv >> A_$1.tsv
   grep -F -f B_pos_$1.txt Fake_frequencies.tsv >> B_$1.tsv
